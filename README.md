...
```
cd existing_repo
git remote add origin https://gitlab.com/interview3314711/hrms.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/interview3314711/hrms/-/settings/integrations)
